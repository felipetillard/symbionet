  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-white/10 pb-4">
        <h2 className="text-xl font-semibold text-white mb-2">WhatsApp Checkout</h2>
        <p className="text-white/60 text-sm">
          Configure your WhatsApp number to receive customer orders and enable checkout via WhatsApp.
        </p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-orange-300/80 text-sm">
                Your customers cannot complete purchases until you set up a WhatsApp number. Configure it below to enable checkout.
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-white/50 text-xs">
              Enter the phone number where you want to receive customer orders (include country code, e.g., +1234567890)
            </p>
          </div>
        </div>
        ...
        {whatsappNumber && isValidNumber && (
          <div className="bg-white/5 rounded-xl p-4 border border-white/10">
            ...
            <p className="text-white/70 text-sm mb-3">
              When customers checkout, they&apos;ll be redirected to WhatsApp with a message like:
            </p>
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-3">
              <p className="text-green-300 text-sm font-mono">
                Hi! I&apos;d like to order:<br/>
                • Product Name x1 - $32.00<br/>
                Total: $32.00<br/><br/>
