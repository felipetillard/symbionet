    ...
    <div className="relative flex min-h-screen flex-col bg-gray-50 justify-between overflow-x-hidden">
      <div>
        <div className="flex items-center bg-gray-50 p-4 pb-2 justify-between">
          ...
          <h2 className="text-[#101319] text-lg font-bold flex-1 text-center pr-12">Confirmación de Pedido</h2>
        </div>
        <h3 className="text-[#101319] text-lg font-bold px-4 pb-2 pt-4">Resumen del Pedido</h3>
        <div className="p-4">
          <div className="flex justify-between gap-x-6 py-2"><p className="text-[#586d8d] text-sm">Número de Pedido</p><p className="text-[#101319] text-sm text-right">#123456789</p></div>
          <div className="flex justify-between gap-x-6 py-2"><p className="text-[#586d8d] text-sm">Fecha</p><p className="text-[#101319] text-sm text-right">26 de Julio, 2024</p></div>
        </div>
        {[1,2,3].map((i)=> (
          <div key={i} className="flex items-center gap-4 bg-gray-50 px-4 min-h-[72px] py-2 justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col justify-center">
                <p className="text-[#101319] text-base font-medium leading-normal line-clamp-1">Artículo {i}</p>
                <p className="text-[#586d8d] text-sm leading-normal line-clamp-2">Talla M</p>
              </div>
            </div>
            <div className="shrink-0"><p className="text-[#101319] text-base">$60.00</p></div>
          </div>
        ))}
        <h3 className="text-[#101319] text-lg font-bold px-4 pb-2 pt-4">Detalles de Pago</h3>
        <div className="p-4">
          ...
          <div className="flex justify-between gap-x-6 py-2"><p className="text-[#586d8d] text-sm">Envío</p><p className="text-[#101319] text-sm text-right">$5.00</p></div>
